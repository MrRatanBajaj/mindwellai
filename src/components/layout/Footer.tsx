      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="font-medium text-sm text-slate-900 mb-4">Platform</h3>
            <ul className="space-y-3">
              <li>
                <NavLink to="/" className="text-slate-600 hover:text-mindwell-600 text-sm transition-colors">
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink to="/about" className="text-slate-600 hover:text-mindwell-600 text-sm transition-colors">
                  About
                </NavLink>
              </li>
              <li>
                <NavLink to="/consultation" className="text-slate-600 hover:text-mindwell-600 text-sm transition-colors">
                  Consultation
                </NavLink>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            <h3 className="font-medium text-sm text-slate-900 mb-4">Connect</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-slate-600 hover:text-mindwell-600 text-sm transition-colors">
                  Contact Us
