            ...
            <AnimatePresence mode="wait">
              ...
              {mode === "otp-verify" ? (
                ...
                <motion.div key="auth-forms" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                  {/* ✨ Hero: Google sign-in promoted to top */}
                  <div className="mb-5">
                    <Button
                      type="button"
                      variant="outline"
                      ...
                      disabled={isLoading}
                      className="w-full h-12 rounded-xl border-2 border-calm-sage/30 bg-gradient-to-r from-calm-sage-light/30 via-card to-calm-sky-light/30 hover:from-calm-sage-light/50 hover:to-calm-sky-light/50 gap-3 font-semibold text-foreground shadow-sm transition-all"
                    >
                      ...
                      {isLoading ? "Please wait..." : "Continue with Google — one tap"}
                    </Button>
                    <p className="text-[11px] text-muted-foreground text-center mt-2">
                      Fastest way in · we'll never post anything for you
                    </p>
                  </div>
